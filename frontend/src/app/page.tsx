...
import { Search, Calendar, MapPin, Users, Star, Filter, Clock, ArrowRight, Sparkles, TrendingUp, Heart, ChevronRight, Globe, Users as UsersIcon, MessageSquare, Image as ImageIcon } from "lucide-react"
import Link from "next/link"
import Image from "next/image"

// Mock data for MVP with image URLs
const featuredEvents = [
  {
    id: 1,
    title: "Summer Music Festival 2024",
    description: "Annual summer festival with multiple stages, international artists, and gourmet food trucks",
    date: "June 15, 2024",
    ...
    reviews: 428,
    featured: true,
    badges: ["Headliner", "Early Bird", "VIP Available"],
    image: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
  {
    id: 2,
    title: "Tech Startup Networking Gala",
    description: "Exclusive networking event for tech entrepreneurs, investors, and innovators",
    date: "June 20, 2024",
    time: "6:00 PM - 9:00 PM",
    location: "Silicon Valley Innovation Hub",
    category: "Business & Tech",
    organizer: "Tech Connect International",
    attendees: 320,
    capacity: 400,
    price: "$89",
    originalPrice: "$120",
    ...
    reviews: 156,
    featured: true,
    badges: ["Invite Only", "Limited Seats"],
...
const popularEvents = [
  {
    ...
    description: "Start your day with peaceful yoga and guided meditation in nature",
    date: "Every Saturday",
    time: "8:00 AM - 9:30 AM",
    location: "Riverside Park Pavilion",
    category: "Wellness",
    organizer: "Zen Yoga Collective",
    attendees: 85,
    capacity: 100,
    price: "$25",
    originalPrice: "$35",
  ...
  },
  {
    ...
    location: "Downtown Modern Gallery",
  ...
  },
  {
    ...
    description: "Curated tasting tour of the city's best culinary spots with sommelier",
    date: "June 22, 2024",
    time: "12:00 PM - 4:00 PM",
    location: "Historic Food District",
    category: "Food & Drink",
    ...
    rating: 4.9,
    reviews: 167,
    image: "https://images.unsplash.com/photo-1510629954389-c1e0da47d414?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
  {
    id: 6,
    title: "Blockchain & Web3 Conference",
    description: "Latest trends in blockchain technology with industry leaders",
    date: "June 25, 2024",
...
const trendingNow = [
  { title: "Outdoor Fitness Bootcamp", category: "Fitness", attendees: 180, trending: "🔥 Hot", image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
  { title: "Local Farmers Market", category: "Community", attendees: 350, trending: "⭐ Popular", image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
  { title: "Startup Pitch Competition", category: "Business", attendees: 120, trending: "📈 Trending", image: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
]
...
const stats = [
  ...
  { value: "200+", label: "Event Organizers" },
]
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="container py-16">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Events people are joining right now</p>
          </div>
            ...
            >
              ...
              <div className="p-4">
                ...
                <Button variant="ghost" size="sm" className="w-full h-8 text-blue-600 hover:text-blue-700" asChild>
                  <Link href={`/events/trending/${index}`}>
                    Join Event
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-3 left-3 flex gap-1">
                  {event.badges.map((badge, idx) => (
                    <Badge key={idx} className="bg-white/90 text-blue-700 border-blue-200">
                      {badge}
                    </Badge>
                  ))}
                </div>
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex flex-wrap gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-medium text-sm text-gray-900">{event.location}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
      ...
      {/* Popular Events Grid with Images */}
      <section className="bg-gray-50 py-16">
        <div className="container">
          <div className="flex items-center justify-between mb-10">
            <div>
              <h2 className="text-2xl font-bold mb-2 text-gray-900">Popular Events</h2>
              <p className="text-gray-600">Events loved by our community</p>
            </div>
            <Button variant="ghost" size="sm" className="text-gray-600 hover:text-gray-900" asChild>
              <Link href="/events/popular">
                View All
                <ChevronRight className="ml-2 h-3 w-3" />
              </Link>
            </Button>
